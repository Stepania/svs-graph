...
namespace SVSModel
{
    class Fertiliser
    {
                                                     ...
                                                     Dictionary<DateTime, double> testResults)
        {
            ...
            if (splits > 0)
            {
                foreach (DateTime d in schedullingDates)
                {
                    ...
                    {
                        AddFertiliser(ref soilN, NAppn * efficiency, d);
                        fert[d] += NAppn;
                        FertApplied += NAppn;
        ...
        public static void ApplyExistingFertiliser(ref Dictionary<DateTime, double> fertiliserN,
                                                   ref Dictionary<DateTime, double> soilN,
                                                   ref Dictionary<DateTime, double> lostN,
                                                   Dictionary<DateTime, double> appliedN)
        {
            ...
            foreach (DateTime d in appliedN.Keys)
            {
                ...
                {
                    AddFertiliser(ref soilN, appliedN[d] * efficiency, d);
                }
        ...
        public static void AddFertiliser(ref Dictionary<DateTime, double> soilN, double fertN, DateTime fertDate)
        {
